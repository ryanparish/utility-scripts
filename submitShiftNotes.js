...
const questionInit = baseURI + ratingType + "/" + selectedPosition + employeeID;
...
const strengths = player.GetVar("shiftNotesStrengths");
const opportunities = player.GetVar("shiftNotesOpportunities");
const general = player.GetVar("shiftNotesGeneral");
